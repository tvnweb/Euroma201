<ul class="filter">
			...
			<li class="filterparams-<?php echo $id_filter_ul; ?>">
				...
				<div class="bottoni" style="display:none;">
					<div class="bottoneRicerca"><img src="<?php bloginfo("template_url");?>/idee-regalo/images/nullpix.png" style="width:60px;height:67px" title="<?php _e(utf8_encode($lang_cercaRegalo)); ?>"/></div>
				</div>
				<div class="spinner" style="display:none"><img src="<?php bloginfo("template_url");?>/idee-regalo/images/ajax-loader.gif" class="loaderimg" style="margin-left: 21px; margin-top: 16px;"/></div>
